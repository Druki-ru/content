...
Данный репозиторий содержит исходные документы для [Drupal энциклопедии](https://druki.ru).
...
* [Контрибуция](#контрибуция)
  ...
  * [Простые изменения](#простые-изменения)
  * [Добавления словаря в PHPStorm](#добавление-словаря-в-phptorm)
  * [Массовая проверка опечаток и орфографии](#массовая-проверка-опечаток-в-phpstorm)
