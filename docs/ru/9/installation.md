...
Для того чтобы установить Drupal, вам потребуется исходный код системы. Если вы всё ещё его не загрузили, воспользуйтесь [руководством по загрузке Drupal](download.md) для быстрого старта.

Убедитесь что окружение соответствует [системным требованиям](system-requirements.md) для корректной работы Drupal.

## Запуск процесса установки

Для того чтобы запустить установку Drupal, достаточно открыть адрес сайта в вашем локальном окружении.

## Этапы установки

### Выбор языка

![Выбор языка](https://i.ibb.co/FJFL6b8/druki-1.png)
...
![Выбор профиля](https://i.ibb.co/kBmhpn2/druki-2.png)
...
![Установка баз данных](https://i.ibb.co/QKMwqdC/druki-3.png)
...
![Установка сайта](https://i.ibb.co/7zyXxM5/druki-4.png)
...
![Установка переводов](https://i.ibb.co/f2WZgkb/druki-5.png)
...
![Настройка сайта](https://i.ibb.co/mT9nS1T/druki-6.png)
...
![Ваш сайт на Drupal](https://i.ibb.co/c3m1nxD/druki-7.png)
...
После того как вы установили Drupal, рекомендуется ознакомиться с его [административным интерфейсом](admin/admin.md). Попробуйте менять [настройки системы](admin/admin-config.md), различные [модули](admin/admin-modules.md) и [темы оформления](admin/admin-appearance.md), поставляемые ядром.

Изучите список [интернет-ресурсов Drupal сообщества](../community/community-resources.md) и вступайте в чаты, задавайте вопросы, читайте блоги и смотрите видео!

Если вы разработчик, и вас интересует техническая сторона, рекомендуется начать с самых основных тем, таких как [Drupal API](api.md), а затем, узнать что такое [модули](modules/modules.md) и [темы оформления](themes/themes.md).
