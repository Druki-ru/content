...
Релиз Drupal 9 состоится в 2020 году. Это произойдёт одновременно с релизом <abbr title="поддержка в течение длительного периода">long-term-support</abbr> (LTS) версии Drupal 8. По приблизительным данным релиз Drupal 8.9.0 LTS состоится 3 июня 2020, а Drupal 9 — 3 августа 2020 года.
