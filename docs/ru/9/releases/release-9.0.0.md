...
> [!NOTE]
> Данная страница содержит список изменений внесенный только в ветку 9.0.x. Это значит, что для полноценной картины изменений вам также необходимо ознакомиться с изменениями [Drupal 8.9.0](../../8/releases/release-8.9.0.md) и [Drupal 8.8.7](../../8/releases/release-8.8.7.md), которые также попали в 9.0.x.
