...
metatags:
  ...
  description: 'Подписка на событие Drupal 9.'
category:
  area: События
  title: Подписка на событие
  order: 3
...
Подписка на событие осуществляется при помощи [создания](../services/create-service.md) [сервиса](../services/services.md) с меткой.
...
Далее,  регистрируем объект в качестве [сервиса](../services/services.md) с меткой:
...
> [!TIP]
> Для быстрой генерации подписчика можно использовать [Drush](../../drush.md) команду `drush generate event-subscriber`.
