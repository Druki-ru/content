...
search-keywords:
 - hooks
metatags:
  title: 'Drupal 9: Создание собственных хуков (hooks)'
...
Таким образом, выбор хуков — не самый лучший выбор в реалиях Drupal 9, тем не менее, он является поддерживаемым, и хуки, скорее всего, не исчезнут и в Drupal 9.
