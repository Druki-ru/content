...
- [#3070375](https://www.drupal.org/project/drupal/issues/3070375) (откачено в [Drupal 8.9.5](../8.9.5/index.md) и [Drupal 9.0.5](../../../../9/releases/9.0.x/9.0.5/index.md)) Исправлены стили из-за которых отображались скрытые кнопки в off-canvas диалоге.
