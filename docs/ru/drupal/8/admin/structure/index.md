...
Информация на странице актуальна для [Drupal 8](../../index.md). Вы можете ознакомиться с [вариантом для Drupal 9](../../../9/admin/structure/index.md).
