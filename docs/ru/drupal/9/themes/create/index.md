...
- **[Drupal 9.4.0](../../../releases/9/9.4.x/9.4.0/index.md) (15.06.2022)**: Добавлена поддержка опции `starterkit`.
- **[Drupal 9.3.0](../../../releases/9/9.3.x/9.3.0/index.md) (08.12.2021):** Добавлена поддержка опций `lifecycle` и `lifecycle_link` в ***.info.yml** файле.
