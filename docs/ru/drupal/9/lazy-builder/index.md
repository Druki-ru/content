...
* **[Drupal 9.2.0](../releases/9.2.x/9.2.0/index.md) (02.06.2021):** Система рендера теперь выбрасывает исключение, если в качестве результата функции обратного вызова возвращается что-то отличное от рендер массива.
