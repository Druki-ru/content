...
- **[Drupal 9.3.0](../../releases/9/9.3.x/9.3.0/index.md) (в разработке):** Возможность указывать префиксы для конкретных таблиц помечена устаревшей.
