...
**Inbound Processor** и **Outbound Processor** — [сервисы](../services.md) с меткой `path_processor_inbound` и `path_processor_outbound` позволяющие программно обрабатывать входящие и исходящие пути сайта.
