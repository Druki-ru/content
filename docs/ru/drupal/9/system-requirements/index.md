...
- 7.3 — минимальная версия до [Drupal 9.4.0](../../releases/9/9.4.x/9.4.0/index.md).
- 7.4 - минимальная версия с [Drupal 9.4.0](../../releases/9/9.4.x/9.4.0/index.md).
- 8.0 — поддержка добавлена начиная с [Drupal 9.1.0](../../releases/9/9.1.x/9.1.0/index.md). Рекомендуемая начиная с [Drupal 9.4.0](../../releases/9/9.4.x/9.4.0/index.md).
