...
- [#2404105](https://www.drupal.org/project/drupal/issues/2404105) Теперь при установке [дистрибутивов](../distributions/distributions.md) блоки устанавливается только для конкретной темы, а не для всех активных.
