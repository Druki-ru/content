...
> [!TIP]
> Вы также можете создать аналогичную тему без использования команды генерации. Для этого скопируйте директорию `/core/themes/starterkit_theme` в `/themes/custom` и замените все упоминания `starterkit_theme` на название вашей новой темы. Не забудьте про названия хуков!
