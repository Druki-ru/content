...
**Прекращение исправления ошибок**: 16 ноября 2020\
**Прекращение поддержки безопасности**: 2 июня 2021
...
Новый функционал и возможности будут добавляться начиная с [Drupal 9.1.0](release-9.1.0.md).

> [!NOTE]
> На странице представлен список изменений внесенных только в ветку 9.0.x. Изменения внесённые в активные версии [Drupal 8.9.0](../../8/releases/release-8.9.0.md) и [Drupal 8.8.7](../../8/releases/release-8.8.7.md) описаны на соответствующих страницах и также попали в Drupal 9. Настоятельно рекомендуется ознакомиться с ними, чтобы иметь полную картину изменений.
