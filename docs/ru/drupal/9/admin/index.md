...
**Административный интерфейс** — инструменты для управления вашим сайтом состоящие из набора страниц с формами для добавления, удаления и редактирования содержания и структуры сайта.
