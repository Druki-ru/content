...
Если на вашем проекте есть собственные [модули](../modules/index.md) и/или [темы оформления](../themes/index.md), то вам необходимо убедиться что они в актуальном состоянии и совместимы с Drupal 10.
...
После того как обновление завершилось, не забудьте запустить обновление баз данных: либо перейдя на `/update.php`, либо при помощи [Drush](../../../drush/index.md):
