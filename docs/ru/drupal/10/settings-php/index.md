...
slug: wiki/10/settings-php
core: 10
metatags:
  title: 'Drupal 10: settings.php — настройки окружения сайта'
...
Drupal использует HTTPS протокол для получения информации об обновлениях. Данная особенность требует чтобы на сервере было установлено [OpenSSL расширение для PHP](https://www.php.net/manual/en/openssl.installation.php), в противном случае получить информацию об обновлениях будет невозможно.
