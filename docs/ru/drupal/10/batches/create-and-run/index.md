...
slug: wiki/10/batches/create-and-run
core: 10
metatags:
  title: 'Drupal 10: Создание и запуск пакетной обработки'
  description: 'Создание и запуск пакетной обработки данных в Drupal 10.'
category:
