---
title: 'Drupal 8.8.0'
slug: wiki/drupal/releases/8.8.0
core: 8
metatags:
...
Путь до конфигураций синхронизации теперь хранится в `$settings['config_sync_directory']` файла [settings.php](../../../../8/settings-php/index.md).
...
В ядро добавлена возможность указывать список [модулей](../../../../8/modules/index.md), который будут исключены из в момент экспорта конфигураций.
...
Используйте [хуки](../../../../8/hooks/index.md) для сущностей, вместо старых, предназначенных для старых синонимов.
...
- [#3086531](https://www.drupal.org/node/3086531) [Темы оформления](../../../../8/themes/index.md) теперь могут быть помечены как экспериментальные: `experimental: true`.
...
- [#3009387](https://www.drupal.org/node/3009387) Функция `drupal_get_user_timezone()` была заменена на [подписчик события](../../../../8/events/index.md). Теперь можно использовать стандартную функцию PHP `date_default_timezone_get()` для получения актуального часового пояса.
...
- [#3088233](https://www.drupal.org/node/3088233) Добавлены новые [хуки](../../../../8/hooks/index.md) для изменения Views UI.
...
- [#3079797](https://www.drupal.org/node/3079797) Типы ресурсов JSON:API теперь могут быть программно настроены при помощи [событий](../../../../8/events/index.md).
...
- [#3075165](https://www.drupal.org/node/3075165) `Drupal\media_library\Form\FileUploadForm` теперь принимает `file_usage` [сервис](../../../../8/services/index.md) в конструкторе.
...
- [#3086614](https://www.drupal.org/node/3086614) Конфигурации [установочных профилей](../../../../8/distributions/index.md) теперь имеют приоритет над конфигурациями по умолчанию, предоставляемых модулями.
