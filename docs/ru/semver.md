...
Начиная с [Drupal 8](8/drupal-8.md) в ядре адаптировали семантическое версионирование. Таким образом, начиная с данной мажорной версии друпала, именование ведётся в соответствии с данной спецификацией.
...
- [Соглашение об именовании релизов в Drupal](standards/release-naming-conventions.md)
