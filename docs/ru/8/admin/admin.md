...
- {Содержимое}(admin-content:8) — Управление содержимым сайта.
- {Структура}(admin-structure:8) — Управление структурированными данными сайта.
- {Оформление}(admin-appearance:8) — Управление темами оформления сайта.
