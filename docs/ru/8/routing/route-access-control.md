...
metatags:
  title: 'Маршрутизация Drupal 8: Контроль доступа'
  description: 'Контролируем доступ к маршрутом при помощи _custom_access, или собстивенного сервиса Access Check.'
---
