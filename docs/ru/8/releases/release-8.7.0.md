...
- Перед обновлением на 8.7.0, вам необходимо удалить контриб модуль при помощи [Composer](../../composer/composer.md) `composer remove drupal/jsonapi`, если не используете композер, то папку с модулем.
