...
- Если вы используете модуль Pathauto, **вам необходимо обновить модуль, как минимум, до версии 1.6**, а только затем обновлять ядро. Если вы пользуетесь [Composer](../../composer.md), то Drupal 8.8.0 указывает Pathauto версии 8.x-1.5 и ниже как конфликтные.
