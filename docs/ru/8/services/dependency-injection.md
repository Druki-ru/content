...
> [!WARNING]
> Использование данного подхода в ООП коде приводит к серьезному снижению производительности системы. 

> [!IMPORTANT]
> В объектах с поддержкой DI, данный подход - худший из возможных. Если вы используете его в подобных объектах, задумайтесь о рефакторинге.
