...
Начиная с [Drupal 8](../drupal/8/index.md) в ядре адаптировали [семантическое версионирование](../semver/index.md), что открыло возможность проводить полноценную депрекацию устаревших возможностей. Благодаря этому [Drupal 9.0](../drupal/9/releases/9.0.x/9.0.0/index.md) является точной копией [Drupal 8.9](../drupal/8/releases/8.9.x/8.9.0/index.md) за исключением устаревших возможностей, которые были удалены из кодовой базы.
