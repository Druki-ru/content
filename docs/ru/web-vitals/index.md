...
* Используйте встроенное в Drupal кэширование: [Internal Dynamic Page Cache](../drupal/9/dynamic-page-cache/index.md), Internal Page Cache. Для большинства небольших сайтов будет достаточно включить Internal Page Cache для достижения рекомендуемых значений.
