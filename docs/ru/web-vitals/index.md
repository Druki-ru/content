...
* Используйте встроенное в Drupal кеширование: [Internal Dynamic Page Cache](../drupal/9/dynamic-page-cache/index.md), Internal Page Cache. Для большинства небольших сайтов будет достаточно включить Internal Page Cache для достижения рекомендуемых значений.
...
* Если данные персональные и не кешируемые — загружайте их лениво. Вы можете использовать «ленивые строители» и «стратегии рендера плейсхолдеров» для различных подходов. Попробуйте использовать поставляемый в комплекте модуль BigPipe.
