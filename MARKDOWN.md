...
Конечные ссылки будуте в дальнейшем заменены на настоящие URL материалов и их алиасы, так что, всё что нужно, сослаться на нужный файл в репозитории, относительно текущего.
