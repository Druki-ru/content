...
Для того чтобы сослаться на материалы из репозитория, а также, содержимое на сайте, необходимо использовать относительные ссылки на файлы, содержащие контенте.
